...
export default function Dashboard({ code }) {
  ...
  useEffect(() => {
    ...
    spotifyApi.getMyTopTracks({ limit: 5, time_range: "long_term" }).then(res => {
      setUserTopTracks(
  ...
  useEffect(() => {
    ...
    spotifyApi.getMyTopArtists({ limit: 5, time_range: "long_term" }).then(res => {
